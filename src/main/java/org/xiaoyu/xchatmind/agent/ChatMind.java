...
public class ChatMind {
    ...
    // 刷新 pendingMessages, 通过 sse 发给前端
    ...
    private boolean think() {
        ...
        // 将thinkPrompt通过 .user(thinkPrompt)添加到chatClient中
        // 让每次messageList的最后一条提示词都是thinkPrompt
        // 避免将提示词添加到聊条记录中
    ...
    public void run() {
        ...
        try {
            ...
            throw new RuntimeException("Error occurred during agent execution", e);
        }
    }
