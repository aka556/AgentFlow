...
public class ChatMessageConverter {
    ...
    public ChatMessage toEntity(ChatMessageDTO chatMessageDTO) throws JsonProcessingException {
        Assert.notNull(chatMessageDTO, "chatMessageDTO must not be null");
        Assert.notNull(chatMessageDTO.getRole(), "role must not be null");
    ...
    public ChatMessageDTO toDTO(ChatMessage chatMessage) throws JsonProcessingException {
        ...
        Assert.notNull(chatMessage.getRole(), "role must not be null");
