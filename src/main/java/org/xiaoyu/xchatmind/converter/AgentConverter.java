...
public class AgentConverter {
    ...
    public Agent toEntity(AgentDTO agentDTO) throws JsonProcessingException {
        Assert.notNull(agentDTO, "agentDTO must not be null");
        Assert.notNull(agentDTO.getAllowedTools(), "allowedTools must not be null");
        Assert.notNull(agentDTO.getAllowedKbs(), "allowedKbs must not be null");
